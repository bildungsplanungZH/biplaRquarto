...
#set page(
    ...
    header: align(left)[#image("images/logo_ktzh_flag_71x71.png", height: 20%) #text("Kanton Zürich\nBildungsdirektion\nBildungsplanung")]
)
...
= Abbildungen
<abbildungen>
Die Abbildungen werden direkt aus dem Chunk generiert. Der Titel kann über die Chunk-Optionen mitgegeben werden. Wird mit der Chunk-Option ein Label gesetzt (`label: fig-ex`), wird die Abbildung automatisch nummeriert und kann mit `@fig-ex` referenziert werden (#ref(<fig-ex>, supplement: [Abbildung])).
...
#figure([
#box(image("template_files/figure-typst/fig-ex-1.svg"))
