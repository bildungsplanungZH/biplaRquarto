...
#' @param path Pfad zum Schreiben der YAML-Datei, default ist Sys.getenv("R_USER")
#'
...
set_author <- function(vorname, nachname, email, dir, org1, org2 = NA, path = Sys.getenv("R_USER")) {
    ...
    yaml::write_yaml(user_info, file.path(path, ".profile.yml"), fileEncoding = "UTF-8", indent = 4)
